...
var friday: [Act] = [
    ...
    Act(name: "Bundarr",
        shortName: "Bundarr",
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 18, minute: 0, timeZone: timeZone),
        endTime: dateFrom(year: 2023, month: 9, day: 8, hour: 20, minute: 0, timeZone: timeZone),
        stage: "Main",
    ...
    Act(name: "PEEKABOO",
        shortName: "PEEKABOO",
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 20, minute: 0, timeZone: timeZone),
