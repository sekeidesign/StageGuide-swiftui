...
var friday: [Act] = [
    Act(name: "Dashi",
        shortName: "Dashi",
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 18, minute: 0, timeZone: timeZone),
        endTime: dateFrom(year: 2023, month: 9, day: 8, hour: 19, minute: 0, timeZone: timeZone),
        stage: "Main",
    ...
    Act(name: "Bundarr",
        shortName: "Bundarr",
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 18, minute: 30, timeZone: timeZone),
        endTime: dateFrom(year: 2023, month: 9, day: 8, hour: 20, minute: 30, timeZone: timeZone),
        stage: "Main",
    ...
    Act(name: "PEEKABOO",
        shortName: "PEEKABOO",
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 18, minute: 15, timeZone: timeZone),
        endTime: dateFrom(year: 2023, month: 9, day: 8, hour: 21, minute: 0, timeZone: timeZone),
        stage: "Main",
    ...
    Act(name: "Deorro B2B Valentino Khan",
        shortName: "VK & Deorro",
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 21, minute: 0, timeZone: timeZone),
        endTime: dateFrom(year: 2023, month: 9, day: 8, hour: 22, minute: 0, timeZone: timeZone),
        stage: "Main",
    ...
    Act(name: "Seven Lions",
        ...
        startTime: dateFrom(year: 2023, month: 9, day: 8, hour: 22, minute: 0, timeZone: timeZone),
        endTime: dateFrom(year: 2023, month: 9, day: 8, hour: 24, minute: 0, timeZone: timeZone),
        stage: "Main",
