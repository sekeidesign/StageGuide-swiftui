...
func populateInitialData() {
    ...
    sevenLions.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 21, minute: 45, timeZone: timeZone)
    sevenLions.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 23, minute: 0, timeZone: timeZone)
