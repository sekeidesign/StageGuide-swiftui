...
func populateInitialData() {
    ...
    vanpage.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 15, minute: 0, timeZone: timeZone)
    vanpage.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 15, minute: 40, timeZone: timeZone)
    ...
    niceotope.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 15, minute: 40, timeZone: timeZone)
    niceotope.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 16, minute: 20, timeZone: timeZone)
    ...
    paqs.id = UUID()
    paqs.name = "PAQS"
    paqs.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 16, minute: 20, timeZone: timeZone)
    paqs.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 17, minute: 0, timeZone: timeZone)
    ...
    hamro.id = UUID()
    hamro.name = "HAMRO"
    hamro.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 17, minute: 0, timeZone: timeZone)
    hamro.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 17, minute: 50, timeZone: timeZone)
    ...
    waves.id = UUID()
    waves.name = "Waves"
    waves.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 17, minute: 50, timeZone: timeZone)
    waves.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 18, minute: 40, timeZone: timeZone)
    ...
    laszewo.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 18, minute: 40, timeZone: timeZone)
    laszewo.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 19, minute: 40, timeZone: timeZone)
    ...
    peekaboo.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 19, minute: 40, timeZone: timeZone)
    peekaboo.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 20, minute: 40, timeZone: timeZone)
    ...
    dvk.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 20, minute: 40, timeZone: timeZone)
    dvk.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 21, minute: 40, timeZone: timeZone)
    ...
    sevenLionsBreak.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 21, minute: 40, timeZone: timeZone)
    sevenLionsBreak.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 21, minute: 45, timeZone: timeZone)
    ...
    sevenLions.startTime = dateFrom(year: 2023, month: 9, day: 7, hour: 21, minute: 45, timeZone: timeZone)
    sevenLions.endTime = dateFrom(year: 2023, month: 9, day: 7, hour: 23, minute: 13, timeZone: timeZone)
    ...
    friday.name = "Friday"
    friday.startTime = dateFrom(year: 2023, month: 9, day: 5, hour: 15, minute: 0, timeZone: timeZone)
    friday.endTime = dateFrom(year: 2023, month: 9, day: 5, hour: 23, minute: 45, timeZone: timeZone)
